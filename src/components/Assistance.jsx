      ...
      <section className="grid sm:grid-flow-col gap-8 sm:ga-6 sm:auto-cols-fr">
        <article className="flex flex-col text-center sm:text-left gap-4">
          <div className="flex   sm:items-start items-center flex-col gap-4">
            ...
            <div
              className="sm:justify-start justify-center flex p-2 items-center shadow-md rounded  transition-all duration-200 ease-in hover:outline-2  bg-blue-800 font-semibold text-white hover:bg-white hover:outline
