          ...
          <section className=" bg-slate-50">
            <section className="w-full max-w-[1310px] m-auto  pt-20 px-10 ">
              ...
              <section className="grid sm:grid-flow-col gap-8 sm:gap-6 sm:auto-cols-fr">
                <article className="flex flex-col text-center sm:text-left gap-4">
                  <p>
                    Dachuan Technologies GmbH is a Munich-based technology
                    company that provides a manufacturing platform for CNC
                    turning and milling parts. It is our goal to make the
                    manufacturing of individual drawing parts as fast and
                    efficient as possible for both customers and suppliers, and
                    thus forming the digital backbone of an efficiently
                    networked manufacturing industry.
                  </p>

                  <p>
                    To achieve this, we have a team of highly skilled
                    professionals with extensive experience in the field of
                    machining. We utilize state-of-the-art machinery and
                    advanced technology to guarantee that every piece we produce
                    is flawless in every aspect.
                  </p>
                  <p>
                    In addition to the quality of our products, we strive to
                    offer excellent service to our customers. Our team works
            ...
            <section className="w-full max-w-[1310px] m-auto   pt-10 px-10 ">
              <section className="grid sm:grid-flow-col gap-8 sm:gap-6 sm:auto-cols-fr">
                <article className="flex flex-col text-center sm:text-left gap-4">
                  <p>
                    Trust is a core value in our company. We endeavour to earn
                    and maintain the trust of our customers through transparency
                    in our operations, punctuality in delivery, and consistency
                    in the quality of our products.
                  </p>
                  <p>
                    At our company, we take pride in providing our customers
                    with the highest quality products. Our number one priority
                    is to ensure that every part that leaves our facility meets
            ...
            <section className="w-full max-w-[1310px] m-auto py-10 px-10 ">
              ...
              <section className="grid sm:grid-flow-col  pt-2 gap-8 sm:gap-6 sm:auto-cols-fr">
                <article className="flex flex-col text-center sm:text-left gap-4">
                  ...
                  <p>
                    We take great pride in sharing that we have a vast network
                    of clients spread across the world. From North America to
                    Asia, from Europe to Oceania, our global community continues
                    to grow each day. This signifies that not only have we met
                    the needs of our clients, but we have also exceeded their
                    expectations.
                  </p>
                  <p>
                    Our dedication and passion for delivering high-quality
                    products and services have enabled us to cultivate solid and
                    lasting relationships with our clients. We deeply value
                    their loyalty and support, as they propel us to continuously
                    surpass ourselves and expand further.
                  </p>
                  <p>
              ...
              <section className="flex sm:flex-row gap-4 items-center bg-white justify-between flex-col h-min p-2 rounded">
                <article className=" md:w-[60%]">
                  ...
                  <p>
                    ...
                    lasting relationships with our clients. We deeply value
                    their loyalty and support, as they propel us to continuously
                    surpass ourselves and expand further.relationships with our
                    clients. We deeply value their loyalty and support, as they
                    propel us to continuously surpass ourselves and expand
                    further.
                  </p>
                </article>
