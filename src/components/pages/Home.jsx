        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 text-balance content-center gap-6  justify-center">
          <article className="flex  text-center gap-4 flex-col">
            ...
            <p className="max-w-[60ch] m-auto text-center">
              ...
              capabilities and certifications. Orders can be placed online. Our
              manufacturing network strictly adheres to confidentiality
          ...
          <article className="flex   text-center gap-4 flex-col">
            ...
            <p className="max-w-[60ch] m-auto text-center ">
              ...
              Design for Manufacturability ) feedback to learn about lead times
              and quotes, among other information. Dachuan real-time quoting
              engine (IQE) powered by data science serves you to easily choose
              appropriate price/lead time options for your projects. It is
              compatible with STEP, Mesh, Parasolid, and ACIS files.
            </p>
          </article>
          <article className="flex   text-center gap-4 flex-col">
            <picture className="flex justify-center">
            ...
            <p className="max-w-[60ch] m-auto text-center">
              ...
              ensure that the components you order will be accurately and timely
              delivered.
            </p>
          </article>
        </div>
