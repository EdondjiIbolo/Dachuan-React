        ...
        <article className="grid grid-cols-1 md:grid-flow-col md:auto-cols-fr gap-5">
          <section className="p-3 flex flex-col gap-3">
            ...
            <address className="flex flex-col gap-1">
              ...
              <p>
                <strong>Email:</strong>{" "}
                <a href="mailto:ejemplo@example.com" className="text-blue-600">
                  ejemplo@example.com
                </a>
              </p>
            </address>
              ...
              <div className="flex gap-2 items-start">
                ...
                <div className="px-2 flex flex-col gap-2">
                  <label htmlFor="terminos">
                    Yes, I would like to receive updates about CNC manufacturing
                    and solutions from Dachuan approximately once a month.
                  </label>
