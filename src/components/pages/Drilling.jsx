      ...
      <main className=" relative  ">
        ...
        >
          <section className="relative flex items-center h-86 sm:h-[450px] overflow-hidden ">
            <article className="w-full max-w-[1310px] mx-auto">
              ...
              <section className="sm:px-12 p-4 sm:py-8 h-full flex flex-col z-10 relative w-full bg-white text-wrap gap-4  sm:w-[580px] sm:mr-auto sm:h-[340px] ">
        ...
        <article className="relative">
          ...
          <section data-section="Materials" className=" bg-slate-100 p-8">
            <article className="section-art text-center items-center flex flex-col p-3 gap-4">
